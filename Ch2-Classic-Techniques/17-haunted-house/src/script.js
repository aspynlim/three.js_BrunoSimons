...
const doorRoughnessrTexture = textureLoader.load('/textures/door/roughness.jpg')

const bricksColorTexture = textureLoader.load('/textures/bricks/color.jpg')
const bricksAmbientOcclusionTexture = textureLoader.load('/textures/bricks/ambientOcclusion.jpg')
const bricksNormalrTexture = textureLoader.load('/textures/bricks/normal.jpg')
...
const walls = new THREE.Mesh(
    new THREE.BoxBufferGeometry(4, wallHeight, wallDepth),
    new THREE.MeshStandardMaterial({
        map: bricksColorTexture,
        aoMap: bricksAmbientOcclusionTexture,
        normalMap: bricksNormalrTexture,
...
const door = new THREE.Mesh(
    ...
    new THREE.MeshStandardMaterial({
        ...
        roughnessMap: doorRoughnessrTexture
    })
)
